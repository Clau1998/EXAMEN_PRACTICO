<%-- 
    ...
    Created on : 23/03/2023, 11:01:06 AM
    Author     : claug
--%>
    ...
    <div class="container mt-4">
      ...
      <div class="card"> 
        <div class="card-header">
          <h2 class="subheader">Dar de baja Usuario</h2>         
        </div>

        <div class="card-body">
          <form action="ServletControlador?accion=bajaUsuario&login=${usuario.login}" method="POST" class="was-validated">  
            <div class="row g-3">
              <div class="col">
